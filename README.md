...
In addition to the class-material repository, you will also need to clone a number of other repositories.  Such repositories are associated with the MARS (MIPS Assembler and Runtime Simulator), as well as a repository for each of your deliverables (i.e., assignments).  All of this material are organized within a predefined file hierarchy for organizational purposes.

This README.md file provides you with an overview of this structure, as well as, a set of tasks to perform to get ready for this semester.  Additional information is located within the README.md file within the administrative folder.
...
## Key Information:
  * Required
    - Personal laptop, with the following tools installed
...
## Tasks (to be complete prior to the first day of class)
  1. Establish Accounts:
     ...
     - https://github.com: All deliverables are submitted via GitHub Classrooms. <br/> 
     Create a github account, if you don't have one already. <br/>
     The account name should be clearly identify yourself in a professional manner.
  ...
  1. Install Software on your personal computer:
     ...
     - https://github.com <br /> 
          - Configure your account to authenticate using SSH.
  ...
  1. Setup your local comp122 environment: <br/>
     ...
     1. Clone a copy of this repository:
        ...
        git clone https://github.com/COMP122/comp122-f22.git class-material
        ```
